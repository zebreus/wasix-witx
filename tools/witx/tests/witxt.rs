...
impl witx::Bindgen for AbiBindgen<'_> {
    ...
    fn emit(
        ...
        match inst {
            ...
            I64FromUsize => self.assert("i64.from_usize"),
            ...
            UsizeFromI64 => self.assert("usize.from_i64"),
            ...
            PointerFromI64 { .. } => self.assert("pointer.from_i64"),
            ConstPointerFromI64 { .. } => self.assert("const_pointer.from_i64"),
